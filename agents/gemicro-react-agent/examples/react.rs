...
//!
//! Run with:
//!   GEMINI_API_KEY=your_key cargo run -p gemicro-react-agent --example react
//!
//! Or with a custom query:
//!   GEMINI_API_KEY=your_key cargo run -p gemicro-react-agent --example react -- "Your question here"
//!
//! Available tools:
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let react_config = ReactAgentConfig::default()
